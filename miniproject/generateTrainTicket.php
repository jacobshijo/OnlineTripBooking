...
<html lang="en">
	...
	<head>
		...
		<title>Bookify | Train Ticket</title>
...
<?php
	...
	$bookingDataInsertSQL = "INSERT INTO `trainbookings`(username,date,cancelled,origin,destination,passengers,trainNo) VALUES('$user','$dateFormatted','no','$origin','$destination','$totalPassengers','$trainID')";
...
<?php
file_put_contents('receipts/TrainTicket'.$currentBookingID.'.html', ob_get_contents());
?>
        ...
        window.onload = function () {
            ...
            const countdownInterval = setInterval(function () {
                ...
                if (countdown <= 0) {
                    ...
                    window.location.href = "userDashboardTrainBookings"; // Redirect to the dashboard
                }
