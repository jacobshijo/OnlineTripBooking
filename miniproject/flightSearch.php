...
<body>
    ...
    // Initialize $return to prevent undefined variable warning
    $return = null; 
    ...
    <div class="searchFlights">
        ...
        <div class="query">
             ...
             <b><?php echo $className; ?></b> Flights from <b><?php echo $origin; ?></b> to <b><?php echo $destination; ?></b>
