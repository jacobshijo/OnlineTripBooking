...
<head>
  ...
  <title>Bookify | Dashboard - Train Bookings</title>
  ...
  <div class="container-fluid">
    <div class="userDashboard">
      ...
      <div class="containerBoxLeft">
              ...
              <a href="userDashboardCabBookings.php">
          <div class="menuContainer">
            <span class="fa fa-close"></span> Cab Bookings
          </div>
        </a>
...
<div class="col-sm-7 containerBoxRightHotel text-left">
			...
			<div class="col-sm-12 tickets">
				...
				$hotelBookingsSQL = "SELECT COUNT(*) FROM `trainbookings` WHERE Username='$user' AND cancelled='no'";
				...
				<div class="col-sm-12 ticketTableContainer pullABitLeft" id="hotelBookingsWrapper">
						...
						<table class="table table-responsive">
							...
							<?php
								...
								$hotelBooksSQL = "SELECT * FROM `trainbookings` WHERE username='$user' AND cancelled='no'";
                    ...
                    <a href="receipts/TrainTicket<?php echo $hotelBooksRow['bookingID']; ?>.html" target="_blank">
				...
				<div class="col-sm-12 ticketTableContainer" id="flightTicketsWrapper">
					...
					<div class="noBooking">
						...
						Looks like you haven't booked any trains with us yet. 
...
<script>
  function showCustomConfirmBox(bookingID) {
    ...
    document.getElementById("confirmDeleteButton").onclick = function() {
      window.location.href = "cancelTrainBooking.php?bookingID=" + bookingID;
    };
  }
