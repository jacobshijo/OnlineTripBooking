...
<head>
  ...
  <title>Bookify | Cancelled Train Bookings</title>
  ...
  <div class="container-fluid">
    <div class="userDashboard">
      ...
      <div class="containerBoxLeft">
              ...
              <a href="viewCancelledFlightBookings.php">
                <div class="menuContainer">
...
<div class="col-sm-7 containerBoxRightHotel text-left">
			...
			<div class="col-sm-12 tickets">
				...
				$hotelBookingsSQL = "SELECT COUNT(*) FROM `trainbookings` WHERE Username='$user' AND cancelled='yes'";
				...
				<div class="col-sm-12 ticketTableContainer pullABitLeft" id="hotelBookingsWrapper">
						...
						<table class="table table-responsive">
							...
							<?php
								...
								$hotelBooksSQL = "SELECT * FROM `trainbookings` WHERE username='$user' AND cancelled='yes'";
                  ...
                  <a href="javascript:void(0)" target="_self" class="image-wrapper">
                    ...
                    <span class="popup-text">Train booking canceled, refund successful</span>
                  </a>
                  </td>
          ...
          Looks like you haven't cancelled any train bookings yet. 
