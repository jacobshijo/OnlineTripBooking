...
<div class="modal">
<form class="form" action="paymentcont.php" method="POST">
...
<rect fill="white" height="38.1" width="80"></rect>
  ...
  <div class="input_container">
    <label for="nameOnCard" class="input_label">Card holder full name</label>
    <input id="nameOnCard" class="input_field" type="text" name="nameOnCard" title="Card holder full name" placeholder="Enter your full name" required>
  </div>
  <div class="input_container">
    <label for="cardNumber" class="input_label">Card Number</label>
    <input id="cardNumber" class="input_field" type="tel" name="cardNumber" title="Card Number" placeholder="0000 0000 0000 0000" minlength="19" maxlength="19" required>
  </div>
  <div class="input_container2">
    <label for="expiry" class="input_label">Expiry Date / CVV</label>
    <div class="split">
      <input id="expiry" class="input_field" type="text" name="expiry" title="Expiry Date" placeholder="MM/YY" maxlength="5" required>
      <input id="cvv" class="input_field" type="password" name="cvv" title="CVV" placeholder="CVV" maxlength="3" pattern="\d{3}" required>
    </div>
  </div>
</div>
...
<script>
  ...
  document.getElementById('expiry').addEventListener('input', function(e) {
    ...
    <?php if ($mode == "ReturnTripFlight" || $mode == "OneWayFlight") { ?>
