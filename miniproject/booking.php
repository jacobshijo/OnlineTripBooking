		...
		<div class="bookingWrapper">
			...
			?>
				...
				<div class="col-sm-12">
					...
					<!-- SESSION CODE STATRS-->
					<?php 
					$_SESSION["P_mode"]="Flight Booking";
					$_SESSION["P_price"] = ($adults*$row["fare"])+($children*$row["fare"])+250; 
					?>
					<!-- SESSION CODE ENDS-->
					...
					<form action="passengers.php" method="POST">
						...
						<a href="./index.php" class="confirmButton">&emsp13; Cancel </a>&emsp13;
			...
			?>
				...
				<div class="col-sm-12">
					...
					<!-- SESSION CODE STATRS-->
					<?php 
					$_SESSION["P_mode"]="Hotel Booking";
					$_SESSION["P_price"] = ($_SESSION["noOfRooms"]*$row["price"]*$noOfDays)+250; 
					?>
					<!-- SESSION CODE ENDS-->
			...
			?>
				...
				<div class="col-sm-12">
					...
					<!-- SESSION CODE STATRS-->
					<?php 
					$_SESSION["P_mode"]="Train Booking";
					$_SESSION["P_price"] = ($noOfPassengers*$row[$priceClass])+250; 
					?>
					<!-- SESSION CODE ENDS-->
