...
<html lang="en">
	...
	<head>
		...
		<title>Bookify | Flight Ticket</title>
...
<?php
	...
	$bookingDataInsertSQL = "INSERT INTO `flightbookings`(username,date,cancelled,origin,destination,passengers,type,flight_no) VALUES('$user','$dateFormatted','no','$origin','$destination','$totalPassengers','$mode','$flightNoOutbound')";
...
<?php
file_put_contents('receipts/FlightTicket'.$currentBookingID.'.html', ob_get_contents());
?>
        ...
        window.onload = function () {
            ...
            const countdownInterval = setInterval(function () {
                ...
                if (countdown <= 0) {
                    ...
                    window.location.href = "userDashboardFlightBookings"; // Redirect to the dashboard
                }
