...
<head>
  ...
  <title>Bookify | Cancelled Hotel Bookings</title>
...
<div class="col-sm-7 containerBoxRightHotel text-left">
			...
			<div class="col-sm-12 tickets">
				...
				$hotelBookingsSQL = "SELECT COUNT(*) FROM `hotelbookings` WHERE Username='$user' AND cancelled='yes'";
				...
				<div class="col-sm-12 ticketTableContainer pullABitLeft" id="hotelBookingsWrapper">
						...
						<table class="table table-responsive">
							...
							<?php
								...
								$hotelBooksSQL = "SELECT * FROM `hotelbookings` WHERE username='$user' AND cancelled='yes'";
                  ...
                  <a href="javascript:void(0)" target="_self" class="image-wrapper">
                    ...
                    <span class="popup-text">Hotel booking canceled, refund successful</span>
                  </a>
                  </td>
          ...
          Looks like you haven't cancelled any hotel bookings yet. 
